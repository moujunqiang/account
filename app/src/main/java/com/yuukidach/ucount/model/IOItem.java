...
import com.yuukidach.ucount.HomeFragment;
...
public class IOItem extends DataSupport {
    ...
    // 返回图片资源的id
    public int getSrcId() {
        Resources resources = HomeFragment.resources;
        return resources.getIdentifier(srcName, "drawable", HomeFragment.PACKAGE_NAME);
    }
}
